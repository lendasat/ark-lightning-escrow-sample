...
```
escrow/          Rust library — taproot contract, tx building, signing, Arkade gRPC client
ruby-ext/        Ruby FFI via Magnus — wraps the Rust crate for the Ruby server
...
5. **Sign** — Bob signs ark_tx and checkpoint PSBTs
